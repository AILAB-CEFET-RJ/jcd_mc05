...
def payroll_query(department: str, month: str) -> str:
    ...
    amount = get_payroll_expense(canonical_department, canonical_month)
    if not amount:
        return f"No payroll data found for department={canonical_department}, month={canonical_month}."
    return amount
